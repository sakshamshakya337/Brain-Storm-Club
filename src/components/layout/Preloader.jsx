  ...
  return (
    ...
    >
      <div className="relative flex items-center justify-center mb-8">
        ...
        <div 
          ref={ringRef}
          className="absolute w-40 h-40 border border-slate-200 rounded-full border-t-brand-primary border-r-transparent border-b-transparent border-l-transparent"
        />
